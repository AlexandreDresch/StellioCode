...
export function TimelineSkeleton() {
  return (
    <div className="w-full bg-white p-4 font-sans dark:bg-neutral-950 md:px-4">
      ...
      <div className="relative mx-auto max-w-7xl pb-20">
        ...
        <div className="absolute left-8 top-0 h-full w-[2px] bg-neutral-200 dark:bg-neutral-700 md:left-8" />
      </div>
    </div>
  );
}
