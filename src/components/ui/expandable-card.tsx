    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 rounded-md p-1 sm:p-1.5 md:p-2 shadow-md shadow-black/5">
            <div className="rounded-md bg-white p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-black/5">
